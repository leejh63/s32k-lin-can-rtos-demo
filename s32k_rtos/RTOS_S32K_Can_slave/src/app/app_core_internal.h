...
typedef struct
{
    ...
    uint8_t              can_service_last_error;
    uint8_t              can_transport_last_error;
    uint8_t              can_hw_last_error;
    ...
    uint32_t             can_hw_tx_ok_count;
    uint32_t             can_hw_tx_error_count;
    uint32_t             can_hw_rx_ok_count;
    uint32_t             can_hw_rx_error_count;
    uint32_t             can_hw_rx_drop_count;
} AppCoreDiag;
