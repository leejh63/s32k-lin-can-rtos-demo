...
#define APP_RTOS_HEARTBEAT_TASK_STACK_WORDS 256U
#define APP_RTOS_BUTTON_TASK_PRIORITY    2U
#define APP_RTOS_BUTTON_TASK_STACK_WORDS 256U
#define APP_RTOS_LED_TASK_PRIORITY       2U
#define APP_RTOS_LED_TASK_STACK_WORDS    256U
#define APP_RTOS_CAN_TASK_PRIORITY       3U
#define APP_RTOS_CAN_TASK_STACK_WORDS    1024U
#define APP_RTOS_CAN_IRQ_PRIORITY        3U
#define APP_RTOS_TICK_IRQ_PRIORITY       4U
