...
typedef struct
{
    uint8_t  service_last_error;
    uint8_t  transport_last_error;
    uint8_t  hw_last_error;
    uint8_t  hw_tx_busy;
    uint32_t hw_tx_ok_count;
    uint32_t hw_tx_error_count;
    uint32_t hw_rx_ok_count;
    uint32_t hw_rx_error_count;
    uint32_t hw_rx_drop_count;
} CanModuleDiag;
