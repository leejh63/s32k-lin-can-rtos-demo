...
#ifdef INST_FLEXTIMER_PWM_1
#define ISOSDK_SDK_HAS_PWM                  1
#define ISOSDK_SDK_PWM_INSTANCE             INST_FLEXTIMER_PWM_1
#define ISOSDK_SDK_PWM_INIT_CONFIG          flexTimer_pwm_1_InitConfig
#define ISOSDK_SDK_PWM_CONFIG               flexTimer_pwm_1_PwmConfig
#define ISOSDK_SDK_PWM_INDEPENDENT_CONFIG   flexTimer_pwm_1_IndependentChannelsConfig
#define ISOSDK_SDK_PWM_CHANNEL_COUNT        \
    ((uint32_t)(sizeof(flexTimer_pwm_1_IndependentChannelsConfig) / \
                sizeof(flexTimer_pwm_1_IndependentChannelsConfig[0])))
#endif
